...
class User private constructor(
    ...
    private fun sendAccessCodeToUser(phone: String, code: String) {
        println(".......... sending accessing code $code on $phone")
    }
            ...
            return this.split(" ")
                ...
                .run {
                    when(size) {
                        1 -> first() to null
                        2 -> first() to last()
                        else -> throw IllegalArgumentException("FullName must contain only first name and last name, result ${this@fullNameToPair}")
                    }
                }
        }
    }
